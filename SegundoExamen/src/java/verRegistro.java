...
/**
 *
 * Autor: Molina Reyes Barbara Montserrat
 */
public class verRegistro extends HttpServlet {
    ...
    public void init(ServletConfig cfg) throws ServletException {
        String URL = "jdbc:mysql://localhost/registrodemaquinas";
        String userName = "bichota";
        String password = "m0t0m4m1";

        try {
            Class.forName("com.mysql.jdbc.Driver");
            URL = "jdbc:mysql://localhost/registrodemaquinas";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (grupo.equals("3IM7") || grupo.equals("3IM8") || grupo.equals("3IM9") || grupo.equals("3IM10") || grupo.equals("4IM7") || 
                        grupo.equals("4IM8") || grupo.equals("4IM9") || grupo.equals("4IM10") || grupo.equals("5IM7") || grupo.equals("5IM8") || 
                        grupo.equals("5IM9") || grupo.equals("5IM10") || grupo.equals("6IM7") || grupo.equals("6IM8") || grupo.equals("6IM9") || 
                        grupo.equals("6IM10")) {
                    turno = "matutino";
                } else {
                    turno = "vespertino";
            ...
            out.println("<h1>Hola tu nombre es: " + request.getParameter("nombre") + request.getParameter("bdm1") + "</h1>");
